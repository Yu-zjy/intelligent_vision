...
extern float volatile AX,AY,AZ;
/****************************** PINs ***********************************/

/* Chip Select PIN */
#define ADXL_SPI_NUM         SPI_4           
#define ADXL_SPI_SCK_PIN     SPI4_SCK_C23     //接模块SPC
#define ADXL_SPI_MOSI_PIN    SPI4_MOSI_C22    //接模块SDI
#define ADXL_SPI_MISO_PIN    SPI4_MISO_C21    //接模块SDO
#define ADXL_SPI_CS_PIN      SPI4_CS1_C19     //接模块CS
/* DATA READY PIN */
